...
func newOrderItem(db *gorm.DB, opts ...gen.DOOption) orderItem {
	...
	_orderItem.BookID = field.NewInt32(tableName, "book_id")
	...
	_orderItem.CreatedBy = field.NewString(tableName, "created_by")
	_orderItem.UpdatedAt = field.NewTime(tableName, "updated_at")
	_orderItem.UpdatedBy = field.NewString(tableName, "updated_by")
	_orderItem.DeletedAt = field.NewField(tableName, "deleted_at")
	_orderItem.DeletedBy = field.NewString(tableName, "deleted_by")
